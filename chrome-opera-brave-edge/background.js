...
async function refresh(force) {
  ...
  // Kljuc -> { text } ako je uspesno, ili { error } ako nije.
  const fetched = {};
  ...
  // npr. nova baza mogla da se aktivira uz STARU whitelistu, pa ljudi koji
  // su tek izuzeti ostanu oznaceni do sledece uspele provere.
  // storage.local.set ovde je jedan poziv - browser ga primenjuje u jednom
  // komadu, pa content skripte nikad ne vide pomesane stare/nove liste.
  if (errors.length) {
